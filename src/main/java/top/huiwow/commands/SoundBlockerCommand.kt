...
class SoundBlockerCommand : CommandBase() {
    private var openConfigNextTick = false

    // 命令的名称，触发用：/mymod
    override fun getCommandName(): String = "soundblocker"

    // 命令的别名，触发用：/mm
    override fun getCommandAliases(): List<String> = listOf("soundblockers")

    // 命令用法提示
    override fun getCommandUsage(sender: ICommandSender): String = "/soundblocker"
