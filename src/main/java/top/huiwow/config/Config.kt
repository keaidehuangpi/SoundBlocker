...
object Config : Vigilant(File("./config/soundBlocker/config.toml")) {
    ...
    @Property(
        type = PropertyType.SWITCH,
        name = "Hide Disabled Sounds",
        description = "Don't show sounds you have blocked when editing blocked sounds.",
        category = "Main",
    )
    var hideDisabledSounds = false
    ...
    init {
        ...
        val clazz = javaClass
        addDependency(clazz.getDeclaredField("hideDisabledSounds"), clazz.getDeclaredField("editBlocked"))
